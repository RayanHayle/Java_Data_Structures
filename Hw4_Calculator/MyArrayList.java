...
public class MyArrayList<E> implements MyList<E>,MyStack<E>{
     ...
     */
     ...
     public E pop () throws StackException{ //  2
     //base method if its empty, and remove from the top
     if (isEmpty()){
         throw new StackException("Attempt to pop from empty stack.");
     }
     //  // call remove method so the top gets popped off
     return remove(size-1);
     }

     public E peek() throws StackException{ //  3
         // you are just looking not deleting or adding to anything
