...
public class BSTMapTestCases {

    public static final double DELTA = 1e-7;

    private Method getTraversal(BSTMap map, String traversal) throws NoSuchMethodException {
        Method method = map.getClass().getDeclaredMethod(traversal, Node.class, StringBuilder.class, int.class);
        method.setAccessible(true);
        return method;
    }

    private Method getIterativeSearchMethod(BSTMap map) throws NoSuchMethodException {
    ...
    public void testPut01() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        retVal = map.put(5, 2);
        assertEquals(null, retVal);
        assertEquals(2, ((Node<Integer, Integer>)getIterativeSearchMethod(map).invoke(map, 5)).parent.key);
        retVal = map.put(12, 13);
        assertEquals(null, retVal);
        assertEquals(10, ((Node<Integer, Integer>)getIterativeSearchMethod(map).invoke(map, 12)).parent.key);
    ...
    public void testCreateBST01() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        BSTMap<Integer, Integer> map = new BSTMap<>(pairs, true);
        // Tree should be:
        //     2
        //    / \
        //   /   \
        ...
        assertEquals(2, ((Node<Integer, Integer>)getIterativeSearchMethod(map).invoke(map, 0)).parent.key);
        assertEquals(2, ((Node<Integer, Integer>)getIterativeSearchMethod(map).invoke(map, 4)).parent.key);
        assertEquals(0, ((Node<Integer, Integer>)getIterativeSearchMethod(map).invoke(map, 1)).parent.key);
        assertEquals(4, ((Node<Integer, Integer>)getIterativeSearchMethod(map).invoke(map, 3)).parent.key);
        assertEquals(4, ((Node<Integer, Integer>)getIterativeSearchMethod(map).invoke(map, 5)).parent.key);
    }
    ...
    public void testCreateBST02() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        assertEquals(1, ((Node<Integer, Integer>)getIterativeSearchMethod(map).invoke(map, 0)).parent.key);
        assertEquals(4, ((Node<Integer, Integer>)getIterativeSearchMethod(map).invoke(map, 1)).parent.key);
        assertEquals(1, ((Node<Integer, Integer>)getIterativeSearchMethod(map).invoke(map, 2)).parent.key);
        assertEquals(2, ((Node<Integer, Integer>)getIterativeSearchMethod(map).invoke(map, 3)).parent.key);
        assertEquals(null, ((Node<Integer, Integer>)getIterativeSearchMethod(map).invoke(map, 4)).parent);
        assertEquals(7, ((Node<Integer, Integer>)getIterativeSearchMethod(map).invoke(map, 5)).parent.key);
        assertEquals(5, ((Node<Integer, Integer>)getIterativeSearchMethod(map).invoke(map, 6)).parent.key);
        assertEquals(4, ((Node<Integer, Integer>)getIterativeSearchMethod(map).invoke(map, 7)).parent.key);
        assertEquals(7, ((Node<Integer, Integer>)getIterativeSearchMethod(map).invoke(map, 8)).parent.key);
        assertEquals(8, ((Node<Integer, Integer>)getIterativeSearchMethod(map).invoke(map, 9)).parent.key);
    }
